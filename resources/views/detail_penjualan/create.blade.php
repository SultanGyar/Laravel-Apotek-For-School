...
@section('content_header')<h1 class="m-0 text-dark">Tambah Detail Penjualan</h1>
@stop
@section('content')
...
@error('jumlah_jual') is-invalid @enderror"
                                ...
                                value="{{ old('jumlah_jual') }}" onchange="subto()">
                            @error('jumlah_jual')
...
@error('harga_jual') is-invalid @enderror"
                                id="harga_jual" placeholder="Harga Jual" name="harga_jual" value="{{ old('harga_jual') }}" onchange="subto()">
                            @error('harga_jual')
...
@error('sub_total_jual') is-invalid @enderror"
                                ...
                                value="{{ old('sub_total_jual') }}" onchange="subto()">
...
@error('nonota_jual') is-invalid @enderror"
                                    placeholder="No. Penjualan" id="nonota_jual" name="nonota_jual"
                                    value="{{ old('nonota_jual') }}" arialabel="Alamat" aria-describedby="cari" readonly>
...
@error('nama_obat') is-invalid @enderror"
                                    ...
                                    arialabel="Email" aria-describedby="cari" readonly>
                                <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari"
