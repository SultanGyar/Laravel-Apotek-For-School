...
@error('jumlah_jual') is-invalid @enderror" id="jumlah_jual" placeholder="Jumlah Jual" name="jumlah_jual"
                            value="{{$detail_penjualan->jumlah_jual ?? old('jumlah_jual')}}" onchange="subto()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control 
@error('harga_jual') is-invalid @enderror" id="harga_jual" placeholder="Harga Jual" name="harga_jual"
                            value="{{$detail_penjualan->harga_jual ?? old('harga_jual')}}" onchange="subto()">
...
@error('sub_total_jual') is-invalid @enderror" id="sub_total_jual" placeholder="Sub Total Jual" name="sub_total_jual"
                            value="{{$detail_penjualan->sub_total_jual ?? old('sub_total_jual')}}" onchange="subto()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="id_penjualan" id="id_penjualan"
                                value="{{$detail_penjualan->id_penjualan ?? old('id_penjualan') }}">
                            <input type="text" class="form-control
@error('nonota_jual') is-invalid @enderror" placeholder="No. Penjualan" id="nonota_jual" name="nonota_jual"
                                value="{{$detail_penjualan->fpenjualan->nonota_jual ?? old('nonota_jual')}}"
                                arialabel="Alamat" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="id_obat" id="id_obat"
                                value="{{$detail_penjualan->id_obat ?? old('id_obat')}}">
                            <input type="text" class="form-control
@error('nama_obat') is-invalid @enderror" placeholder="Nama Obat" id="nama_obat" name="nama_obat"
                                value="{{$detail_penjualan->fobat->nama_obat ?? old('nama_obat')}}" arialabel="Email"
