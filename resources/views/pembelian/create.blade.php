                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="nonota_beli">Nomor Nota Pembelian</label>
...
@error('tgl_beli') is-invalid @enderror"
                                id="tgl_beli" placeholder="Tanggal Pembelian" name="tgl_beli"
                                value="{{ old('tgl_beli') }}">
                            @error('tgl_beli')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
...
@error('name') is-invalid @enderror"
                                    placeholder="ID User" id="name" name="name" value="{{ auth()->user()->name }}"
        ...
        <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable p-5">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel2">Pencarian Data ID User</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
