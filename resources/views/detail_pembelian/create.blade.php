...
@section('content_header')<h1 class="m-0 text-dark">Tambah Detail Pembelian</h1>
@stop
@section('content')
<form action="{{route('detail_pembelian.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
...
@error('tgl_kadarluarsa') is-invalid @enderror" id="tgl_kadarluarsa" placeholder="Tanggal Kadarluarsa"
                            name="tgl_kadarluarsa" value="{{old('tgl_kadarluarsa')}}">
...
@error('harga_beli') is-invalid @enderror" id="harga_beli" placeholder="Harga Beli" name="harga_beli" value="{{old('harga_beli')}}" onkeyup="subtotal()">
...
@error('jumlah_beli') is-invalid @enderror" id="jumlah_beli" placeholder="Jumlah Beli" name="jumlah_beli" value="{{old('jumlah_beli')}}" onkeyup="subtotal()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control 
@error('sub_total_beli') is-invalid @enderror" id="sub_total_beli" placeholder="Sub Total Beli" name="sub_total_beli" value="{{old('sub_total_beli')}}" onkeyup="subtotal()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control 
@error('persen_margin_jual') is-invalid @enderror" id="persen_margin_jual" placeholder="Persen Margin Jual" name="persen_margin_jual" value="{{old('persen_margin_jual')}}" onkeyup="subtotal()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control
@error('nonota_beli') is-invalid @enderror" placeholder="No. Pembelian" id="nonota_beli" name="nonota_beli" value="{{old('nonota_beli')}}" arialabel="Alamat" aria-describedby="cari" readonly>
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari" data-bs-target="#staticBackdrop"></i>
                                Cari Data No. Pembelian</button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control
@error('nama_obat') is-invalid @enderror" placeholder="Nama Obat" id="nama_obat" name="nama_obat" value="{{old('nama_obat')}}" arialabel="Email" aria-describedby="cari" readonly>
    ...
    <script>
        function subtotal() {
            ...
            margin = persen/100;
            sementara = harga * jumlah;
            keuntungan = sementara * margin;

            total = harga * jumlah + keuntungan;
