...
@error('nonota_jual') is-invalid @enderror"
                                id="nonota_jual" placeholder="No Nota Jual" name="nonota_jual"
...
@error('tgl_jual') is-invalid @enderror"
                                id="tgl_jual" placeholder="Tanggal Jual" name="tgl_jual"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="hidden" name="id_user" id="id_user"
                                    value="{{ $penjualan->id_user ?? old('id_user') }}">
                                <input type="text" class="form-control
@error('name') is-invalid @enderror"
                                    placeholder="Nama User" id="name" name="name"
                                    value="{{ $penjualan->fuser->name ?? old('name') }}" arialabel="Email"
