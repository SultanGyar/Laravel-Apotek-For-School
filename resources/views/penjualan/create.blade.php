...
@error('tgl_jual') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            <label for="total_jual">Total Penjualan</label>
                            <input type="number" class="form-control 
@error('total_jual') is-invalid @enderror"
                                id="total_jual" placeholder="Total Penjualan" name="total_jual"
        ...
        @error('email') is-invalid @enderror"
                                    placeholder="ID User" id="email" name="email" value="{{ old('email') }}"
