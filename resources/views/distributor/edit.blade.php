...
<form action="{{route('distributor.update', $distributor)}}" method="post">
   ...
   @error('nama_distributor') is-invalid @enderror" id="exampleInputEmail" placeholder="Masukan Nama Distributor"
                                name="nama_distributor"
                                value="{{$distributor->nama_distributor ??old('nama_distributor')}}">
   ...
   @error('alamat') is-invalid @enderror" id="exampleInputEmail" placeholder="Masukan Alamat Distributor" name="alamat"
                                value="{{$distributor->alamat ??old('alamat')}}">
   ...
   @error('notelepon') is-invalid @enderror" id="exampleInputEmail" placeholder="Masukan Merk Obat" name="notelepon"
                                value="{{$distributor->notelepon ??old('notelepon')}}">
